...
void clock_set_next_event(void) { sbi_set_timer(get_cycles() + timebase); }
    ...
    80200170:	0cb0006f          	j	80200a3a <sbi_set_timer>
...
void cons_putc(int c) { sbi_console_putchar((unsigned char)c); }
    ...
    8020017a:	0a50006f          	j	80200a1e <sbi_console_putchar>
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    80200668:	ba478793          	addi	a5,a5,-1116 # 80201208 <error_string+0x38>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    802006bc:	9bca0a13          	addi	s4,s4,-1604 # 80201074 <etext+0x602>
    ...
    802006c8:	b0cc0c13          	addi	s8,s8,-1268 # 802011d0 <error_string>
    ...
    802007b6:	b0660613          	addi	a2,a2,-1274 # 802012b8 <error_string+0xe8>
    ...
    8020094a:	96260613          	addi	a2,a2,-1694 # 802012a8 <error_string+0xd8>
    ...
    8020095c:	94860613          	addi	a2,a2,-1720 # 802012a0 <error_string+0xd0>
            if (width > 0 && padc != '-') {
    80200960:	00001417          	auipc	s0,0x1
    80200964:	94140413          	addi	s0,s0,-1727 # 802012a1 <error_string+0xd1>
                for (width -= strnlen(p, precision); width > 0; width --) {
    ...
    802009f0:	8b540413          	addi	s0,s0,-1867 # 802012a1 <error_string+0xd1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
void sbi_set_timer(unsigned long long stime_value) {
    ...
    80200a3e:	5e678793          	addi	a5,a5,1510 # 80204020 <SBI_SET_TIMER>
    __asm__ volatile (
